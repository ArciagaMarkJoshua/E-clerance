...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2025 at 06:51 AM
...
(9, '2022-02243', 'Pending', '2025-05-03 12:51:22'),
...
(17, '1111', 'Pending', '2025-04-30 05:57:07'),
...
(21, '222222', 'Pending', '2025-05-03 12:52:25');
...
(1, 'Library Clearance', 'Screenshot of the library page', 1),
(2, 'Guidance Interview', 'photo id', 1),
...
(5, 123, 'Mark', 'arciagamarkjoshua@gmail.com', '$2y$10$5VJsUzIrFPJJ4oPEmtqGVemYEqOqkOkd7GjbywkRN9jSWORsNKH4.', 'Arciaga', 'Mark Joshua', 'Perico', 'Office of the Dean', 'Staff'),
(6, 2, 'reanne', 'reannematias0909@gmail.com', '$2y$10$qkssuNUpR3GsYhLOfHO0KOwt985fS3pzNzesJAL5f7iSMgAGPJ4xq', 'Matias', 'Reeanne', 'Sta.rosa', 'Office of the Finance Director', 'Staff');
...
(3, '1111', 'Andrei', 'andreimartinez@gmail.com', '$2y$10$6Q2HJoD0CbU4mTBcQM.7T.pcY8LgtGdX0uWrbqsKeGnUd.FKToNhm', 'Martinez', 'Andrei', 'Perico', 'BSCS', 3, '3c', '2024-2025', 'Second Semester', 'STU'),
...
(13, '222222', 'Mark', 'dad@gmail.com', '$2y$10$IvTYXNHQC6CQu6V.0LcrZuVga/KHR1muS0YCAtiwI8TLXmoJrPN82', 'Arciaga', 'Mark Joshua', 'Perico', 'BSCS', 1, '3B', '2023-2024', '2nd Semester', 'STU');
...
('1111', 1, 1, 'Approved', NULL, NULL, '2025-05-07 07:14:27'),
('1111', 2, 1, 'Approved', NULL, NULL, '2025-05-07 07:14:30'),
('1111', 3, 1, 'Approved', NULL, NULL, '2025-05-07 07:14:31'),
('1111', 4, 1, 'Approved', NULL, NULL, '2025-05-07 07:14:32'),
('1111', 5, 1, 'Approved', NULL, NULL, '2025-05-07 07:14:33'),
('1111', 6, 1, 'Approved', NULL, NULL, '2025-05-21 15:28:56'),
('1111', 7, 1, 'Pending', NULL, NULL, '2025-04-30 06:09:59'),
('2022-02243', 1, 123, 'Approved', NULL, NULL, '2025-05-03 12:51:58'),
('2022-02243', 2, 1, 'Approved', NULL, NULL, '2025-05-07 04:00:39'),
('2022-02243', 3, 1, 'Approved', NULL, NULL, '2025-05-21 15:48:13'),
('2022-02243', 4, 1, 'Pending', NULL, NULL, '2025-05-03 12:51:24'),
('2022-02243', 5, 1, 'Pending', NULL, NULL, '2025-05-03 12:51:25'),
('2022-02243', 6, 1, 'Pending', NULL, NULL, '2025-05-03 12:51:26'),
('2022-02243', 7, 1, 'Pending', NULL, NULL, '2025-05-03 12:51:26'),
...
('222222', 1, 1, 'Pending', NULL, NULL, '2025-05-03 12:52:25'),
('222222', 2, 1, 'Pending', NULL, NULL, '2025-05-03 12:52:26'),
('222222', 3, 1, 'Pending', NULL, NULL, '2025-05-03 12:52:26'),
('222222', 4, 1, 'Pending', NULL, NULL, '2025-05-03 12:52:27'),
('222222', 5, 1, 'Pending', NULL, NULL, '2025-05-03 12:52:27'),
('222222', 6, 1, 'Approved', NULL, NULL, '2025-05-02 12:13:19'),
('222222', 7, 1, 'Pending', NULL, NULL, '2025-05-03 12:52:29');
...
--
ALTER TABLE `clearance`
  MODIFY `clearance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `students`
  MODIFY `CtrlNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
